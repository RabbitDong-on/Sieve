...
public interface SchedulerService extends Remote{
    ...
    void reportNonBlockingStartTime(ScheduleInfo info,long startTime)throws RemoteException;
    void reportNonBlockingEndTime(ScheduleInfo info,long endTime)throws RemoteException;
}