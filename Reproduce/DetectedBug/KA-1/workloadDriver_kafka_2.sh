...
function experiment {
    ...
    do
        ...
        #./kafka/bin/kafka-producer-perf-test.sh --topic test --num-records 500 --throughput -1 --record-size 1000 --producer-props bootstrap.servers=172.30.0.2:9092,172.30.0.3:9092,172.30.0.4:9092 acks=1
        #./kafka/bin/kafka-consumer-perf-test.sh --broker-list 172.30.0.2:9092,172.30.0.3:9092,172.30.0.4:9092 --topic test --fetch-size 1048576 --messages 500 
        # --consumer-property group.id=group_test
